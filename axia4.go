...
import (
	...
	"axia4/handler"
	"axia4/handler/api"
	"axia4/handler/api_auth"
	"axia4/handler/cache_download"
	"axia4/handler/client_download"
	"axia4/handler/csv_download"
	"axia4/handler/csv_upload"
	"axia4/handler/data_access"
	"axia4/handler/data_auth"
	"axia4/handler/data_download"
	"axia4/handler/data_download_thumb"
	"axia4/handler/data_upload"
	"axia4/handler/doc_download"
	"axia4/handler/icon_upload"
	"axia4/handler/ics_download"
	"axia4/handler/license_upload"
	"axia4/handler/manifest_download"
	"axia4/handler/transfer_export"
	"axia4/handler/transfer_import"
	"axia4/handler/websocket"
	"axia4/ldap"
	"axia4/log"
	"axia4/login"
...
func main() {
	...
	if !config.File.Portable && service.Interactive() && len(os.Args) == 1 {
		...
		fmt.Printf("https://axia4.net/docs/admin/ for the full admin documentation.\n")
		fmt.Printf("################################################################################\n\n")
